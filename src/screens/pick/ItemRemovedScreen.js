  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={{ paddingBottom: 20 }}>
        <ImageWithLabel
          iconName={'ItemRemovedSVG'}
          statusTitle="Item removed from 
          the cart"
          statusText="The customer has not agreed for auto substitution in case he is not available when called."
        />
        <ItemSection
          title={item.name}
...
export default ItemRemovedScreen;
